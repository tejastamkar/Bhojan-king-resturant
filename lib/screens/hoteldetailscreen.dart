...
// import 'package:restroapp/widgets/reviewsheet.dart';
...
class _HotelDetialsScreenState extends State<HotelDetialsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget showImages() => CarouselSlider(
            ...
            children: [
              Stack(
                ...
                children: [
                  InkWell(
                    onTap: () => showDialog(
                        context: context, builder: (context) => showImages()),
                    child: Image.asset(
                      "${restroCardList[0]["image"]}",
                      scale: 1 / 1,
                      fit: BoxFit.cover,
                      width: width,
                    ),
